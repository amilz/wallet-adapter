...
/**
 * A wallet discovered through the wallet standard. Derived from the wallet plugin's own state so
 * every type in this package references a single wallet-standard instance.
 */
...
/** The value returned by {@link useWallet}. */
